...
<html>
  ...
  <body>
    <div class="row">
      <center><h2 style="margin-top:5px;"><i class="fa fa-shopping-cart" style="border-radius:50px; border:2px solid #fff; padding: 5px;"></i>MyShop</h2></center>
      <div class="col m4 s12 offset-m4 form">
        <form class="" action="" method="post">
          <h4><i class="fa fa-user"></i>Please Sign In</h4>
          <hr>
          <div class="input-field">
            <input type="text" id="username" class="validate" name="username" value="">
            <label for="username">Email / Username</label>
          </div>
          <div class="input-field">
            <input type="password" id="pass" class="validate" name="password" value="">
      ...
      <div class="col m4 s12 offset-m4">
        ...
        <center>Belum punya akun ? Daftar <a href="<?= base_url(); ?>home/registrasi">disini</a>
          <p><a href="<?= base_url(); ?>"><i class="fa fa-home" style="font-size:30px;"></i>
          Back to Home</a></p>
        </center>
      </div>
    </div>
