    ...
    <form class="form-horizontal form-label-left" action="" method="post">
      <div class="form-group">
        ...
        <div class="col-md-5 col-sm-6 col-xs-12">
          <input type="password" class="form-control col-md-7 col-xs-12" name="password1" value="">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5 col-sm-6 col-xs-12">
          <input type="password" class="form-control col-md-7 col-xs-12" name="password2" value="">
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2">
          ...
          <button type="button" onclick="window.history.go(-1)" class="btn btn-danger" name="button">Kembali</button>
        </div>
      </div>
    </form>
  </div>
