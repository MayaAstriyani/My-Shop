    ...
    method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 col-sm-6">
          <input type="number" class="form-control col-md-7 col-xs-12" name="harga" value="<?= $harga; ?>">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 col-sm-6">
          <input type="number" class="form-control col-md-7" name="berat" value="<?= $berat; ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-6">
          ...
          <?php foreach ($kat->result() as $k) :?>
            <input type="checkbox" name="kat[]" value="<?= $k->kategori;?>" onclick="addlist(this, 'txt1')" <?php if ($rk) { foreach ($rk->result() as $l) {
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button class="btn btn-primary" onclick="window.history.go(-1)" type="button">Kembali</button>
        </div>
      </div>
    </form>
  </div>
