...
<div class="row">
  ...
  <div class="col m7 s12 offset-m1">
    ...
    <br>
    <button type="button" class="btn red waves-effect waves-light" onclick="window.history.go(-1)" name="button">Kembali</button>
    <a href="<?= base_url(); ?>cart/add/<?= $key->id_item; ?>" class="btn blue waves-effect waves-light">
