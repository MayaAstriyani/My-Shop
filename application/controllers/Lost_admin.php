...
class Lost_Admin extends CI_Controller {
	...
	public function index()
	{
		if ($this->input->post('submit', TRUE) == 'Submit')
		{
			...
			{
				$get = $this->admin->get_where('t_admin', array('email' =>
				...
				if ($get->num_rows() > 0)
				{
					...
					$this->email->message(
						'Apakah anda lupa dengan password anda ? silahkan klik <a href=
						"'.base_url().'lost_admin/reset/'.$key.'">disini</a>. Jika anda tidak merasa request
						fitur ini, silahkan abaikan pesan ini'
					);
